...
from src.training.networks_cips import CIPS2D
...
class Generator(torch.nn.Module):
    ...
    def forward(self, z, p, camera_angles, c=None, camera_angles_cond=None, truncation_psi=1, truncation_cutoff=None, update_emas=False, **synthesis_kwargs):
        ...
        # out = self.synthesis(tex_z, update_emas=update_emas, **synthesis_kwargs)
        out = self.synthesis(tex_z, points=p, camera_angles=camera_angles, update_emas=update_emas, **synthesis_kwargs)
        return out
