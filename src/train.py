...
def main(cfg: DictConfig):
    ...
    c.loss_kwargs = dnnlib.EasyDict(class_name=loss_class_name, cfg=cfg)
    ...
    if cfg.model.name == 'stylegan2':
        ...
        elif cfg.model.name == 'dis3d':
            print("using dis3d")
            c.G_kwargs.class_name = 'training.networks_dis3d.Generator'
